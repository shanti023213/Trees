...
public class NoOfNonLeaves {
	...
	public static void main(String[] args) {
        ...
        System.out.println(noOfNonLeaves(tree));
	}
	
	public static int noOfNonLeaves(Node node){
		...
		return 1+noOfNonLeaves(node.left)+noOfNonLeaves(node.right);
	}
